...
export function isProductCategory(value: unknown): value is ProductCategory {
  return typeof value === 'string' && Object.values(ProductCategory).includes(value as ProductCategory);
}
...
export function isSuccessResponse<T>(value: ApiResponse<T>): value is Extract<ApiResponse<T>, { status: 'success' }> {
  return value.status === 'success';
}

export function isErrorResponse<T>(value: ApiResponse<T>): value is Extract<ApiResponse<T>, { status: 'error' }> {
  return value.status === 'error';
}

export function isLoadingResponse<T>(value: ApiResponse<T>): value is Extract<ApiResponse<T>, { status: 'loading' }> {
...
export function isFormFieldState(value: unknown): value is FormFieldState {
  ...
  return (
    ...
    (obj['type'] === 'idle' || obj['type'] === 'validating' || obj['type'] === 'valid' || obj['type'] === 'invalid') &&
...
export function isNotification(value: unknown): value is Notification {
  ...
  return (
    typeof obj['type'] === 'string' &&
    (obj['type'] === 'success' || obj['type'] === 'error' || obj['type'] === 'warning' || obj['type'] === 'info') &&
    typeof obj['message'] === 'string'
  );
}
