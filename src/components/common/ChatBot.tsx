...
export default function ChatBot({ onPageChange }: ChatBotProps) {
  ...
  const initialMessage: Message = {
    ...
    type: 'bot',
    content:
      "👋 Hi! I'm Alex, your technology consultant assistant. I'm here to help you find the perfect solution for your business needs. What brings you here today?",
    timestamp: new Date(),
    options: [
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div
        className={`glass-effect shadow-2xl border border-border/50 transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-border/20">
          ...
          <div className="flex items-center space-x-1">
            ...
            <Button variant="ghost" size="icon" onClick={closeChat} className="h-6 w-6">
              <X className="w-3 h-3" />
            </Button>
          </div>
        </div>
