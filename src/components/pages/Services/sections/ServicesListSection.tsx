    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-h2 font-bold mb-6">Our Services</h2>
          <p className="max-w-3xl text-body-lg text-muted-foreground">
            We offer a comprehensive suite of ICT solutions designed to secure and streamline your
            operations. Explore our professional services below.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="hidden lg:block">
                  <div
                    className={`flex items-center gap-16 ${isReversed ? 'flex-row-reverse' : 'flex-row'}`}
                  >
                    {/* Image Section */}
