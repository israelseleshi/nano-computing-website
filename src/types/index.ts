...
export type BlogPostSummary = Pick<
  BlogPost,
  'id' | 'title' | 'excerpt' | 'author' | 'publishedAt' | 'featuredImage' | 'readTime'
>;
...
export type ComponentPropsWithRef<T extends keyof React.JSX.IntrinsicElements> = ComponentProps<T> &
  BaseComponentProps;
